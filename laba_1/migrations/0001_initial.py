    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol_file', models.FileField(upload_to='protocols/', verbose_name='Протокол PDF')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('removed', models.BooleanField(default=False, help_text='True если объект удален (мягкое удаление)', verbose_name='Удален')),
            ],
            options={
                'ordering': ['full_name'],
